const quizQuestions = [
    ...
    },
    {
        ...
        category: "한국사",
        difficulty: "hard",
        question: "1919년 4월, '대한민국 임시정부'라는 명칭으로 처음 수립된 도시는? (이후 한성·노령 임정과 통합)",
        options: ["베이징", "난징", "충칭", "상하이"],
        correctAnswer: 3,
        explanation: "대한민국 임시정부는 1919년 4월 11일 중국 상하이에서 수립되었고, 같은 해 9월 한성정부·노령정부와 통합되었습니다. 이후 일제의 탄압을 피해 항저우, 충칭 등으로 이동했습니다."
    },
    {
        id: 44,
        category: "한국사",
    ...
    // 세계지리 (10문제)
    {
        ...
        category: "세계지리",
        difficulty: "medium",
        question: "전통적인 측정 방식(브리태니커 백과사전 기준)으로 세계에서 가장 긴 강은?",
        options: ["아마존강", "나일강", "양쯔강", "미시시피강"],
        correctAnswer: 1,
        explanation: "나일강은 약 6,650km로 전통적 측정 기준 세계에서 가장 긴 강입니다. (단, 일부 2007년 이후 연구에서는 아마존강을 더 길게 보는 견해도 있습니다.)"
    },
    {
        id: 11,
        category: "세계지리",
    ...
    },
    {
        ...
        category: "세계지리",
        difficulty: "medium",
        question: "강수량 기준(연 250mm 미만)으로 분류했을 때 세계에서 면적이 가장 큰 사막은?",
        options: ["사하라 사막", "고비 사막", "남극 사막", "아라비아 사막"],
        correctAnswer: 2,
        explanation: "남극 대륙은 약 1,400만km²의 극지 사막으로 강수량 기준 세계 최대 사막입니다. (모래사막만 한정하면 사하라 사막이 가장 큽니다.)"
    },
    {
        id: 16,
        category: "세계지리",
    ...
    },
    {
        ...
        correctAnswer: 1,
        explanation: "에베레스트산은 해발 8,848.86m로 해발고도 기준 세계 최고봉입니다."
    },
    {
        id: 18,
        category: "세계지리",
        difficulty: "hard",
        question: "면적 기준 세계에서 가장 큰 호수는? (카스피해를 호수로 분류하는 경우)",
        options: ["바이칼호", "슈피리어호", "카스피해", "빅토리아호"],
        correctAnswer: 2,
        explanation: "카스피해는 약 371,000km²로 호수로 분류할 경우 면적 기준 세계 최대 호수입니다. (담수호로 한정하면 슈피리어호가 가장 큽니다.)"
    },
    {
        id: 19,
        category: "세계지리",
    ...
    },
    {
        ...
        category: "세계지리",
        difficulty: "medium",
        question: "면적 기준 세계에서 가장 작은 (UN 회원국 및 옵서버 국가 포함) 나라는?",
        options: ["모나코", "바티칸", "산마리노", "리히텐슈타인"],
        correctAnswer: 1,
        explanation: "바티칸 시국은 약 0.44km²로 면적 기준 세계에서 가장 작은 나라(독립국)입니다."
    },
    ...
    },
    {
        ...
        category: "과학",
        difficulty: "easy",
        question: "표면적과 무게 기준, 인체에서 가장 큰 기관(organ)은?",
        options: ["심장", "간", "폐", "피부"],
        correctAnswer: 3,
        explanation: "피부는 표면적·무게 기준 인체에서 가장 큰 기관(organ)으로 체중의 약 16%를 차지합니다. (내장 기관만 한정하면 간이 가장 큽니다.)"
    },
    {
        id: 30,
        category: "과학",
...
,
    ...
    },
    {
        ...
        category: "세계지리",
        difficulty: "medium",
        question: "2011년 남수단 독립 이후, 아프리카 대륙에서 면적이 가장 큰 국가는?",
        options: ["나이지리아","남아프리카공화국","알제리","이집트"],
        correctAnswer: 2,
        explanation: "알제리는 약 238만km²로 2011년 수단 분단 이후 아프리카에서 가장 큰 국가입니다. (이전에는 수단이 가장 컸습니다.)"
    },
    {
        id: 47,
        category: "과학",
